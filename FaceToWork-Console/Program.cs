...
namespace FaceQuickstart
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			string SUBSCRIPTION_KEY = Environment.GetEnvironmentVariable("27129ff24b3041dea2d42ad8b138e8ca");
			string ENDPOINT = Environment.GetEnvironmentVariable("https://facetowork.cognitiveservices.azure.com/");
			// </snippet_mainvars>
